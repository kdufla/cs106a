...
public class FacePamphletProfile implements FacePamphletConstants {
	 ...
	 * profile.
	 */
	public FacePamphletProfile(String Name, String Month, String Year) {
		name = Name;
		year =Year;
		month = Month;
	}
	...
	//get age of users in years and months
	public String getAge() {
		int getyear, getmonth = 0;
	...
	public String toString() {
		...
		return name + "@"+ month+"@"+year+ "@"+im + "@" + status		
				+ buddy ;
	}
